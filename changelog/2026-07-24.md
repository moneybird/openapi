...
## API Changelog v2-20260723-e9a73aaca1 vs. v2-20260724-0f2366539e

### `GET /{administration_id}/contacts/customer_id/{customer_id}{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `allOf[#/components/schemas/base_contact_response]/notes/items/todo_type` response property for the response status `200`


### `GET /{administration_id}/contacts/filter{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/allOf[#/components/schemas/base_contact_response]/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `todo_type` response property for the response status `201`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `allOf[#/components/schemas/base_contact_response]/notes/items/todo_type` response property for the response status `201`


### `POST /{administration_id}/documents/general_documents/synchronization{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/contact/oneOf[#/components/schemas/simple_contact_response]/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `contact/oneOf[#/components/schemas/simple_contact_response]/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `contact/oneOf[#/components/schemas/simple_contact_response]/notes/items/todo_type` response property for the response status `201`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `201`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `contact/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/contact/notes/items/todo_type` response property for the response status `200`


### `POST /{administration_id}/recurring_sales_invoices/synchronization{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/contact/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/subscription/oneOf[#/components/schemas/subscription_response]/contact/notes/items/todo_type` response property for the response status `200`


### `GET /{administration_id}/recurring_sales_invoices/{id}{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `contact/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `subscription/oneOf[#/components/schemas/subscription_response]/contact/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `contact/notes/items/todo_type` response property for the response status `201`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `201`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `subscription/oneOf[#/components/schemas/subscription_response]/contact/notes/items/todo_type` response property for the response status `201`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `tasks/items/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `groups/items/tasks/items/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `tasks/items/notes/items/todo_type` response property for the response status `201`


### `POST /{administration_id}/task_list_templates/{task_list_template_id}/task_lists{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `groups/items/tasks/items/notes/items/todo_type` response property for the response status `201`


### `GET /{administration_id}/task_list_templates{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/groups/items/tasks/items/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/contact/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/notes/items/todo_type` response property for the response status `200`
...
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/contact/notes/items/todo_type` response property for the response status `200`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `items/sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/notes/items/todo_type` response property for the response status `200`


### `POST /{administration_id}/time_entries{format}`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `notes/items/todo_type` response property for the response status `201`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/contact/notes/items/todo_type` response property for the response status `201`
- :warning: added the new `sales_invoice_payment_email_missing_sender_email` enum value to the `sales_invoice/oneOf[#/components/schemas/sales_invoice_response]/notes/items/todo_type` response property for the response status `201`
